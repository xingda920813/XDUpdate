...
public class XdUpdateAgent {
    ...
    public void update(final Activity activity) {
        ...
        if (TextUtils.isEmpty(localJson) && TextUtils.isEmpty(jsonUrl)) {
            System.err.println("Please set localJson or jsonUrl.");
            return;
        }
        if (!TextUtils.isEmpty(localJson)) {
            updateMatters(localJson, activity);
        } else {
                ...
                public void call(Subscriber<? super Response> subscriber) {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            subscriber.onError(new IOException(response.code() + " : " + response.body()
                                                                                                 .string()));
                        }
                    } catch (Throwable e) {
                        subscriber.onError(e);
                                     ...
                                     .subscribe(new Subscriber<Response>() {
                                         ...
                                         public void onNext(Response response) {
                                             ...
                                             updateMatters(responseBody, activity);
                                         }
                                     });
        }
    }

    protected void updateMatters(String json, final Activity activity) {
        if (XdConstants.debugMode) System.out.println(json);
        ...
        if (currentCode < versionCode || currentName.compareToIgnoreCase(versionName) < 0) {
            ...
            if (!forceUpdate && todayBegin == lastIgnoredDayBegin && versionCode == lastIgnoredCode && versionName
                    .equals(lastIgnoredName))
                return;
    ...
    public static class Builder {
        ...
        public Builder setLocalJson(String jsonString) {
            mLocalJson = jsonString;
            return this;
        }
        ...
        public XdUpdateAgent build() {
            ...
            if (!TextUtils.isEmpty(mLocalJson)) {
                instance.localJson = mLocalJson;
            } else {
